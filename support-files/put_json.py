...
# echo '{"key1":1}' | ./put_json.py --user dbuser:dbpass test2.jpg - http://127.0.0.1:8980/api/example2/table2
...
response = requests.put(url,
               ...
               json={"id": name, "json": json.dumps(json_data)})
